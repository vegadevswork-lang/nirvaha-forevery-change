...
const categoryVisuals: Record<string, { image: string; gradient: string }> = {
  binaural: {
    ...
    gradient: "linear-gradient(160deg, hsl(245 55% 32% / 0.6), hsl(235 65% 16% / 0.92))",
  },
  mantras: {
    image: IMG("photo-1545389336-cf090694435e"),
    gradient: "linear-gradient(160deg, hsl(260 50% 32% / 0.58), hsl(250 60% 16% / 0.92))",
  },
  nature: {
    image: IMG("photo-1441974231531-c6227db76b6e"),
    gradient: "linear-gradient(160deg, hsl(210 55% 28% / 0.55), hsl(220 65% 14% / 0.92))",
  },
  frequency: {
    image: IMG("photo-1511671782779-c97d3d27a1d4"),
    gradient: "linear-gradient(160deg, hsl(270 55% 30% / 0.6), hsl(255 60% 16% / 0.92))",
  },
  breath: {
    image: IMG("photo-1506905925346-21bda4d32df4"),
    gradient: "linear-gradient(160deg, hsl(220 55% 28% / 0.55), hsl(230 65% 14% / 0.92))",
  },
  grounding: {
    image: IMG("photo-1507525428034-b723cf961d3e"),
    gradient: "linear-gradient(160deg, hsl(230 50% 28% / 0.55), hsl(240 60% 14% / 0.92))",
  },
  sleep: {
    image: IMG("photo-1532978879514-6cb1a3a82e4d"),
    gradient: "linear-gradient(160deg, hsl(250 55% 22% / 0.65), hsl(255 70% 10% / 0.94))",
  },
  focus: {
    image: IMG("photo-1499209974431-9dddcece7f88"),
    gradient: "linear-gradient(160deg, hsl(225 55% 26% / 0.6), hsl(240 65% 14% / 0.92))",
  },
};
