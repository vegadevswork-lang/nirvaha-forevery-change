...
export const wellnessPackages: WellnessPackage[] = [
  {
    ...
    description: "Gentle frequencies and nurturing sounds for calm and emotional balance during pregnancy.",
    duration: "7-day journey",
    trackCount: 14,
    icon: "🤰",
    gradient: "linear-gradient(135deg, hsl(330 30% 25%), hsl(280 25% 30%))",
  },
  {
    id: "exam",
    title: "Exam Focus",
    purpose: "Sharpen concentration for peak performance",
    description: "Binaural beats and focus frequencies for memory retention and sustained attention.",
    duration: "5-day journey",
    trackCount: 10,
    icon: "📚",
    gradient: "linear-gradient(135deg, hsl(210 35% 22%), hsl(190 30% 28%))",
  },
  {
    id: "employee",
    title: "Employee Balance",
    purpose: "Restore calm in a busy workday",
    description: "Quick sound resets and stress-relief audio for professionals seeking balance.",
    duration: "5-day journey",
    trackCount: 10,
    icon: "💼",
    gradient: "linear-gradient(135deg, hsl(152 30% 22%), hsl(140 25% 28%))",
  },
  {
    id: "emotional",
    title: "Emotional Harmony",
    purpose: "Process and release emotional weight",
    description: "A curated sound journey for emotional healing — from release to inner peace.",
    duration: "7-day journey",
    trackCount: 14,
    icon: "💚",
    gradient: "linear-gradient(135deg, hsl(42 40% 22%), hsl(35 35% 28%))",
  },
  {
    id: "sleep-recovery",
    title: "Sleep Recovery",
    purpose: "Rebuild your sleep rhythm naturally",
    description: "Progressive sound sessions that ease your body into deep, restorative sleep.",
    duration: "7-day journey",
    trackCount: 14,
    icon: "🌙",
    gradient: "linear-gradient(135deg, hsl(240 25% 20%), hsl(260 20% 26%))",
  },
  {
    id: "anxiety",
    title: "Anxiety Relief",
    purpose: "Gentle grounding when anxiety rises",
    description: "Low-frequency grounding audio and breath-sound sessions to calm your nervous system.",
    duration: "5-day journey",
    trackCount: 10,
    icon: "🫧",
    gradient: "linear-gradient(135deg, hsl(180 25% 20%), hsl(160 20% 26%))",
  },
];
